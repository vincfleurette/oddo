...
class CacheRoutes
{
    public function register(App $app, Container $container): void
    {
        ...
        $app->group("", function ($group) use ($container) {
            $group->get("/cache/info", function (
                ...
                return $this->getCacheInfo($request, $response, $container);
            });
            ...
            $group->delete("/cache", function (
                ...
                return $this->invalidateCache($request, $response, $container);
            });
            ...
            $group->post("/cache/refresh", function (
                ...
                return $this->refreshCache($request, $response, $container);
            });
        })->add($jwtMiddleware);
    }
    ...
    public function getCacheInfo(
        ...
        try {
            ...
            return $this->jsonResponse($response, $info);
        } catch (\Exception $e) {
    ...
    public function refreshCache(
        ...
        try {
            ...
            $dataFetcher = function () use ($container, $credentials) {
                ...
                return array_map(fn($dto) => $dto->toArray(), $accounts);
            };

            // Rafraîchir le cache
            $data = $cacheService->refreshUserAccounts($userId, $dataFetcher);
